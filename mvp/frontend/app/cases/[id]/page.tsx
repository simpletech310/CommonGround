              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Button variant="outline" className="h-auto py-6 flex flex-col items-center gap-2" onClick={() => router.push(`/cases/${caseId}/children`)}>
                      ...
                      <span className="text-xs text-gray-500">Profiles, info & item tracking</span>
                    </Button>
                  </div>
                </CardContent>
              </Card>
